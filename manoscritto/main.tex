...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{imakeidx}
%\usepackage{idxlayout} % [columns=2, font=small]
\makeindex[intoc,options={-s main.mst}]
...
\part{Introduction and state of the art} % Background
...
%\part{Reinforcement Learning} %{Algorithms} % What we did
%\part{Our approach to Reinforcement Learning}
